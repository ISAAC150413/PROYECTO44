class Game {
  ...
  start() {
   ...
   var obstaclesPositions = [
      { x: width / 2 + 50, y: height - 80, image: obstacle2Image },
      { x: width / 2 - 50, y: height - 10, image: obstacle1Image },
      { x: width / 2 + 50, y: height - 10, image: obstacle1Image },
      { x: width / 2 - 80, y: height - 20, image: obstacle2Image },
      { x: width / 2, y: height - 20 ,image: obstacle2Image },
      { x: width / 2 - 80, y: height - 30, image: obstacle1Image },
      { x: width / 2 + 80, y: height - 30, image: obstacle2Image },
      { x: width / 2 + 50, y: height - 30, image: obstacle2Image },
      { x: width / 2 - 50, y: height - 40, image: obstacle1Image },
      { x: width / 2 + 50, y: height - 40, image: obstacle2Image },
      { x: width / 2, y: height - 30, image: obstacle1Image },
      { x: width / 2 - 80, y: height - 50, image: obstacle2Image }
    ];
